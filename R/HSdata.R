...
#'
#' This data set with more variables are available in other R packages such as lavaan, MBESS, and OpenMX.
#'
...
#'
#' @seealso \code{\link[lavaan]{HolzingerSwineford1939}}, \code{\link[MBESS]{HS.data}}, \code{\link[OpenMx]{HS.ability.data}}
#' @keywords datasets
#'
